...
function preload(){
  trex_running = loadAnimation("boy1.png","boy3.png");
  trex_collided = loadAnimation("boy2.png");
  
  groundImage = loadImage("ground2.png");
 
  cloudImage = loadImage("C4.png");
  ...
  obstacle5 = loadImage("z5.png");
  obstacle6 = loadImage("z6.png");
